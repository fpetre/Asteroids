(function () {
  ...
  Game.prototype.addAsteroids = function () {
    ...
    for (var i = 0; i < Game.NUM_ASTEROIDS; i++) {
      ...
      asteroids.push(
        new Asteroids.Asteroid({ pos: pos, game: this, image: this.images["asteroid"], radius: Game.ASTEROID_RADIUS })
      );
    };
  ...
  Game.prototype.splitAsteroid = function (radius, pos) {
    ...
    for (var i = 0; i < 6; i++) {
      this.asteroids.push(
        new Asteroids.Asteroid({pos: pos, game: this, image: this.images["asteroid"], radius: newRadius})
      );
    };
